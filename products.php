...
<?php include 'pdatabase.php'; // Include the database connection ?>
        <header>
    ...
    <section class="products" id="products">
        ...
        <?php
if (!isset($conn)) {
    die("Database connection is not set. Please check your connection file.");
}
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="addtocart.php" class="cart-btn" data-id="' . $row["id"] . '" data-name="' . $row["name"] . '" data-price="' . $row["price"] . '">Add to Cart</a>
...
<script>
    // Inject CSS for Cart Modal and Overlay
    ...
    function renderCart() {
        cartModal.innerHTML = `
            ...
            <div class="total">Total: Rs.${calculateTotal()}</div>
            <button class="close-btn">Close</button>
        `;

        cartModal.querySelectorAll("input[type='number']").forEach((input) => {
